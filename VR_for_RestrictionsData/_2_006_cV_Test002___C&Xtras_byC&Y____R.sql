...
--SELECT 
--Nation_fk,Ctry_EditorialName,Variable,Change,Value2015,Value2014,DecodedValue_2015,DecodedValue_2014,Descr_2015,Descr_2014
-- FROM dbo.v05_ReportData
--SELECT 
--distinct Nation_fk
-- FROM dbo.v05_ReportData
SELECT 
...
--where 
--[Nation_fk] in (SELECT distinct [Nation_fk]
--  FROM [v02_AllCodedValues]
WHERE
       [Question_Year] = 2015
   AND 
