/***************************************************************************************************************************************************************/
Print '--- '+CONVERT(VARCHAR(19),SYSDATETIME())+' ==>  script 1.002    ---------------------------------------------------------------------------------------- '
/***************************************************************************************************************************************************************/
/***                                                                                                                                                         ***/
USE              [GRSHRcode]
GO
...
/*------------------------------------------------------------------------------------------------------------------------*/
   SELECT                                                                      /* select statement...                     */
/*------------------------------------------------------------------------------------------------------------------------*/
             DISTINCT                                                                         /* temporary correction FOR OLDER CODING OF 'GRI_08' */
             [Q]
           , [V]
           , [W]
           , [N]
    ...
    WHERE 
          NOT (
                    ([Q] LIKE 'GRI_08'            AND [V] LIKE 0.50           )    /* temporary correction FOR OLDER CODING OF 'GRI_08' */
                 OR ([Q] LIKE 'GRI_11_[01-13]%'   AND [W] LIKE 'Yes%limited%'  )    /* temporary correction FOR OLDER CODING OF 'GRI_08' */
                 OR ([Q] LIKE 'SHI_01_x_[01-17]%' AND [W] LIKE 'Yes%limited%'  )    /* temporary correction FOR OLDER CODING OF 'GRI_08' */
      ...
      AND NOT (  [V] = 0.00
                AND  (
                       ...
                       OR [Q] LIKE 'SHI_04_d_x_[1,2]'
                       OR [Q] LIKE 'SHI_04_f_x_%'
                       OR [Q] LIKE 'SHI_05_filter'
                       OR [Q] LIKE 'SHI_05_d_x_[1,2]'
                       OR [Q] LIKE 'SHI_05_01'
                       OR [Q] LIKE 'SHI_06'
                       OR [Q] LIKE 'SHI_07'
                       OR [Q] LIKE 'SHI_08'
...
----------------------------------------------------------------------------------------------------------------------------
        , [QClass]                       =       CASE
                                                 ...
                                                 WHEN [AnswerSet_num]                =  999999
                                              AND NOT [Question_abbreviation_std] LIKE 'SHI_0[4,5]_d_x_[1,2]' THEN 'COUNT'
                                                                                                              ELSE 'CODED' END 
----------------------------------------------------------------------------------------------------------------------------
        , [QDescr]                       =          D.[Attr]
        , [QTools]                       =          T.[Attr]
...
GO
/***************************************************************************************************************************************************************/
--					SELECT * FROM [GRSHRcode]..[All_Questions] where [QClass] = 'COUNT'
/***************************************************************************************************************************************************************/
/***************************************************************************************************************************************************************/
/***                                                                                                                                                         ***/
/***                                                                                                                                                         ***/
...
/***************************************************************************************************************************************************************/
/***                                                          **************************************************************************************************/
/***     [AT_Qs]    (all questions in wide table)             **************************************************************************************************/
/***                                                          **************************************************************************************************/
/***************************************************************************************************************************************************************/
IF (SELECT COUNT([TABLE_NAME]) FROM [INFORMATION_SCHEMA].[TABLES]
...
/***************************************************************************************************************************************************************/
/***                                                          **************************************************************************************************/
/***     [TwoYD]    (former & current coding period long set) **************************************************************************************************/
/***                                                          **************************************************************************************************/
/***************************************************************************************************************************************************************/
IF (SELECT COUNT([TABLE_NAME]) FROM [INFORMATION_SCHEMA].[TABLES]
