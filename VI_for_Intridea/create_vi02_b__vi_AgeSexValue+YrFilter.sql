/* ++> create_vi02_b__vi_AgeSexValue+YrFilter.sql <++ */
/* >> this query should be updated by making line 13 referred to forum  !!!!!  << */
/***************************************************************************************************************************************************************/
/***************************************************************************************************************************************************************/
/***************************************************************************************************************************************************************/
/***************************************************************************************************************************************************************/
/***                                                                                                                                                         ***/
/***     >>>>>   This is the script used to create the table [forum_ResAnal]..[vi_AgeSexValue]                                                     <<<<<     ***/
...
/*------------------------------------------------------------------------------------------------------------------------*/
  SET     @TofI = 'vi_AgeSexValue'                                                --  set variable value
/*------------------------------------------------------------------------------------------------------------------------*/
EXEC('
...
-- filter out religions w/0 subrel in lev02_5_display ----------------------------------------------------------------------
        AND   R.Pew_RelL02_5_display           -- data should be aggregated later, because the original
         !=   R.Pew_religion_lev02             -- subdistribution is at level 03
----------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------
          ...
          ,  U.[Data_source_fk]
          ,  U.[NV_Display]
          ,    [RV_Display]      = ISNULL(F.[MedianAge_Data], 1)
----------------------------------------------------------------------------------------------------------------------------
INTO    #B2_CPR_R
----------------------------------------------------------------------------------------------------------------------------
----select *
...
----------------------------------------------------------------------------------------------------------------------------
          ...
          ,    [Data_source_fk]
          ,    [NV_Display]      = 1
--        ,    [RV_Display]      = 1   no longer defaulted to 1 jceo/Mar2015
----------------------------------------------------------------------------------------------------------------------------
FROM
      ( SELECT * FROM #CPRPartI
        UNION ALL
...
--------------------------------------------------------
--select * from #Basic_Age_Sex_Value  --   = 1,335,161
--------------------------------------------------------
/**************************************************************************************************************************/
/**************************************************************************************************************************/
...
SELECT
		...
		, [Percentage]
		, [Data_source_fk]
		, [NV_Display_MedianAge] = [NV_Display]
		, [RV_Display_MedianAge] = [RV_Display]
        , [Sex_fk]
        , [Age_fk]
----------------------------------------------------------------------------------------------------------------------------
    INTO  [forum_ResAnal].[dbo].[vi_AgeSexValue]    -- 616,631
----------------------------------------------------------------------------------------------------------------------------
FROM
          #Basic_Age_Sex_Value
----------------------------------------------------------------------------------------------------------------------------
WHERE
	      [Year]  IN (2010, 2020, 2030, 2040, 2050)
----------------------------------------------------------------------------------------------------------------------------
/**************************************************************************************************************************/
go