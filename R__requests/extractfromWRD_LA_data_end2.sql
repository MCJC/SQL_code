...
,   [class]              = CASE
                               ...
                               THEN 'Catholics'
                               WHEN [Religion_2] IN ( 'A', 'I', 'P' )
                               THEN 'Protestant'
                               WHEN [Religion_2] IN ( 'O' )
                               THEN 'Other Christians'
                               WHEN [Religion_2] IN ( 'U' )
                               THEN '++ U'
