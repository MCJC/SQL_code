...
SELECT
       ...
       , [Nation_fk] 
       , [Locality_fk] 
       , [Religion_fk	Ctry_EditorialName	Locality	Religion	Question_Year	QA_std	QW_std	Answer_value	answer_wording	answer_wording_std	Question_fk	Answer_fk	Notes
