...
-- Syntax
EXEC 
sp_detach_db   @dbname                 = 'for_x'      -- (is a sysname value) name of the database to be detached
...
EXEC 
sp_attach_db   @dbname                 = 'for_x'      -- name of the database to be attached: must be unique
             , @filename1              = 'F:\data\for_x.mdf'     -- physical name, including path, of a database file.
             , @filename2              = 'F:\data\for_x_log.LDF' -- physical name, including path, of a database file.
             ;
GO
-- Set the database to SINGLE_USER mode to obtain exclusive access
-- (after all current users disconnect from the database)
