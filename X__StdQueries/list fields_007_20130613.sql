...
--GO
--/*****************************************************************************************************************************************************/
--ALTER VIEW    [dbo].[v_Current_Survey_Questions]
--AS
--/*****************************************************************************************************************************************************/
---------------------------------------------------------------------------------------------------------------------------------------------------------
--/*****************************************************************************************************************************/
...
--DistinctRows  (counts rows of fields)
 ...
 UNION SELECT COUNT (DISTINCT Display_Footnotes_pk) AS DistinctRows, Field = 'Pew_Display_Footnotes_Display_Footnotes_pk' FROM forum.dbo.Pew_Display_Footnotes UNION SELECT COUNT (DISTINCT List_fk) AS DistinctRows, Field = 'Pew_Display_Footnotes_List_fk' FROM forum.dbo.Pew_Display_Footnotes UNION SELECT COUNT (DISTINCT item_fk) AS DistinctRows, Field = 'Pew_Display_Footnotes_item_fk' FROM forum.dbo.Pew_Display_Footnotes UNION SELECT COUNT (DISTINCT Note_fk) AS DistinctRows, Field = 'Pew_Display_Footnotes_Note_fk' FROM forum.dbo.Pew_Display_Footnotes UNION SELECT COUNT (DISTINCT Note_SortingNumber) AS DistinctRows, Field = 'Pew_Display_Footnotes_Note_SortingNumber' FROM forum.dbo.Pew_Display_Footnotes 
 UNION SELECT COUNT (DISTINCT Display_Reports_pk) AS DistinctRows, Field = 'Pew_Display_Reports_Display_Reports_pk' FROM forum.dbo.Pew_Display_Reports UNION SELECT COUNT (DISTINCT List_fk) AS DistinctRows, Field = 'Pew_Display_Reports_List_fk' FROM forum.dbo.Pew_Display_Reports UNION SELECT COUNT (DISTINCT item_fk) AS DistinctRows, Field = 'Pew_Display_Reports_item_fk' FROM forum.dbo.Pew_Display_Reports UNION SELECT COUNT (DISTINCT Data_source_fk) AS DistinctRows, Field = 'Pew_Display_Reports_Data_source_fk' FROM forum.dbo.Pew_Display_Reports UNION SELECT COUNT (DISTINCT Report_SortingNumber) AS DistinctRows, Field = 'Pew_Display_Reports_Report_SortingNumber' FROM forum.dbo.Pew_Display_Reports 
 ...
 UNION SELECT COUNT (DISTINCT Locality_pk) AS DistinctRows, Field = 'Pew_Locality_Locality_pk' FROM forum.dbo.Pew_Locality UNION SELECT COUNT (DISTINCT Locality) AS DistinctRows, Field = 'Pew_Locality_Locality' FROM forum.dbo.Pew_Locality UNION SELECT COUNT (DISTINCT Province_fk) AS DistinctRows, Field = 'Pew_Locality_Province_fk' FROM forum.dbo.Pew_Locality UNION SELECT COUNT (DISTINCT Weighting) AS DistinctRows, Field = 'Pew_Locality_Weighting' FROM forum.dbo.Pew_Locality UNION SELECT COUNT (DISTINCT Locality_note) AS DistinctRows, Field = 'Pew_Locality_Locality_note' FROM forum.dbo.Pew_Locality UNION SELECT COUNT (DISTINCT nation_fk) AS DistinctRows, Field = 'Pew_Locality_nation_fk' FROM forum.dbo.Pew_Locality 
 UNION SELECT COUNT (DISTINCT Locality_value_pk) AS DistinctRows, Field = 'Pew_Locality_Value_Locality_value_pk' FROM forum.dbo.Pew_Locality_Value UNION SELECT COUNT (DISTINCT Locality_fk) AS DistinctRows, Field = 'Pew_Locality_Value_Locality_fk' FROM forum.dbo.Pew_Locality_Value UNION SELECT COUNT (DISTINCT Field_fk) AS DistinctRows, Field = 'Pew_Locality_Value_Field_fk' FROM forum.dbo.Pew_Locality_Value UNION SELECT COUNT (DISTINCT Locality_Value) AS DistinctRows, Field = 'Pew_Locality_Value_Locality_Value' FROM forum.dbo.Pew_Locality_Value 
 UNION SELECT COUNT (DISTINCT Migration_data_source_pk) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Migration_data_source_pk' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Data_quality_level_fk) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Data_quality_level_fk' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Origin_data_source) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Origin_data_source' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Origin_data_year) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Origin_data_year' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Origin_data_type) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Origin_data_type' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Destination_nation_fk) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Destination_nation_fk' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Origin_nation_fk) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Origin_nation_fk' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Religion_data_source) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Religion_data_source' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Religion_data_year) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Religion_data_year' FROM forum.dbo.Pew_Migration_Data_Source UNION SELECT COUNT (DISTINCT Religion_data_type) AS DistinctRows, Field = 'Pew_Migration_Data_Source_Religion_data_type' FROM forum.dbo.Pew_Migration_Data_Source 
 UNION SELECT COUNT (DISTINCT Nation_age_sex_value_pk) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Nation_age_sex_value_pk' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT Field_fk) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Field_fk' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT Nation_fk) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Nation_fk' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT Age_fk) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Age_fk' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT Sex_fk) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Sex_fk' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT Cnt) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Cnt' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT Data_source) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Data_source' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT Year) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_Year' FROM forum.dbo.Pew_Nation_Age_Sex_Value UNION SELECT COUNT (DISTINCT display) AS DistinctRows, Field = 'Pew_Nation_Age_Sex_Value_display' FROM forum.dbo.Pew_Nation_Age_Sex_Value 
 ...
 UNION SELECT COUNT (DISTINCT Nation_fk) AS DistinctRows, Field = 'Pew_Nation_Language_Nation_fk' FROM forum.dbo.Pew_Nation_Language UNION SELECT COUNT (DISTINCT Pop) AS DistinctRows, Field = 'Pew_Nation_Language_Pop' FROM forum.dbo.Pew_Nation_Language UNION SELECT COUNT (DISTINCT Nation_language_pk) AS DistinctRows, Field = 'Pew_Nation_Language_Nation_language_pk' FROM forum.dbo.Pew_Nation_Language UNION SELECT COUNT (DISTINCT Language_fk) AS DistinctRows, Field = 'Pew_Nation_Language_Language_fk' FROM forum.dbo.Pew_Nation_Language 
 UNION SELECT COUNT (DISTINCT Nation_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Nation_fk' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Source_year) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Source_year' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Source) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Source' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Percentage) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Percentage' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Field_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Field_fk' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Sex_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Sex_fk' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Age_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Age_fk' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Religion_group_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Religion_group_fk' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Notes) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Notes' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Scenario_id) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Scenario_id' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Nation_religion_age_sex_value_pk) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Nation_religion_age_sex_value_pk' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Display) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Display' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Cases) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Cases' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Cases_Notes) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Cases_Notes' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Nation_Value_Source) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Nation_Value_Source' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value UNION SELECT COUNT (DISTINCT Distribution_Wave_id) AS DistinctRows, Field = 'Pew_Nation_Religion_Age_Sex_Value_Distribution_Wave_id' FROM forum.dbo.Pew_Nation_Religion_Age_Sex_Value 
 UNION SELECT COUNT (DISTINCT Nation_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Nation_fk' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Source_year) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Source_year' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Source) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Source' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Rate) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Rate' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Cases) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Cases' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Field_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Field_fk' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Religion_group_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Religion_group_fk' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT measurement) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_measurement' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT notes) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_notes' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT age_fk) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_age_fk' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Scenario_id) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Scenario_id' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Nation_religion_fertility_value_pk) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Nation_religion_fertility_value_pk' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value UNION SELECT COUNT (DISTINCT Display) AS DistinctRows, Field = 'Pew_Nation_Religion_Fertility_Value_Display' FROM forum.dbo.Pew_Nation_Religion_Fertility_Value 
 ...
 UNION SELECT COUNT (DISTINCT Nation_pk) AS DistinctRows, Field = 'Pew_Nation_Nation_pk' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Nation) AS DistinctRows, Field = 'Pew_Nation_Nation' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Country_fk) AS DistinctRows, Field = 'Pew_Nation_Country_fk' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Weighting) AS DistinctRows, Field = 'Pew_Nation_Weighting' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Nation_note) AS DistinctRows, Field = 'Pew_Nation_Nation_note' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Iso_3166_Code) AS DistinctRows, Field = 'Pew_Nation_Iso_3166_Code' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Nicknames) AS DistinctRows, Field = 'Pew_Nation_Nicknames' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Pfcountry) AS DistinctRows, Field = 'Pew_Nation_Pfcountry' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT CtryCapital) AS DistinctRows, Field = 'Pew_Nation_CtryCapital' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Current_pop) AS DistinctRows, Field = 'Pew_Nation_Current_pop' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Reference_pop) AS DistinctRows, Field = 'Pew_Nation_Reference_pop' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Life_Expectancy) AS DistinctRows, Field = 'Pew_Nation_Life_Expectancy' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Literacy_Rate) AS DistinctRows, Field = 'Pew_Nation_Literacy_Rate' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT GDP_per_capita) AS DistinctRows, Field = 'Pew_Nation_GDP_per_capita' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Ctry_EditorialName) AS DistinctRows, Field = 'Pew_Nation_Ctry_EditorialName' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT TPop1990) AS DistinctRows, Field = 'Pew_Nation_TPop1990' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT TPop2000) AS DistinctRows, Field = 'Pew_Nation_TPop2000' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT TPop2010) AS DistinctRows, Field = 'Pew_Nation_TPop2010' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT TPop2020) AS DistinctRows, Field = 'Pew_Nation_TPop2020' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT TPop2030) AS DistinctRows, Field = 'Pew_Nation_TPop2030' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Region) AS DistinctRows, Field = 'Pew_Nation_Region' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT SubRegion) AS DistinctRows, Field = 'Pew_Nation_SubRegion' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT IMF_Advance) AS DistinctRows, Field = 'Pew_Nation_IMF_Advance' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Global_NS) AS DistinctRows, Field = 'Pew_Nation_Global_NS' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT UN_Reg1) AS DistinctRows, Field = 'Pew_Nation_UN_Reg1' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT UN_Reg2) AS DistinctRows, Field = 'Pew_Nation_UN_Reg2' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT UN_Develop) AS DistinctRows, Field = 'Pew_Nation_UN_Develop' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT FOTM_Advance) AS DistinctRows, Field = 'Pew_Nation_FOTM_Advance' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT TPop1910) AS DistinctRows, Field = 'Pew_Nation_TPop1910' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Christian_pct1910) AS DistinctRows, Field = 'Pew_Nation_Christian_pct1910' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Evangelical_pct2010) AS DistinctRows, Field = 'Pew_Nation_Evangelical_pct2010' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Pentecostal_pct2010) AS DistinctRows, Field = 'Pew_Nation_Pentecostal_pct2010' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Charismatic_pct2010) AS DistinctRows, Field = 'Pew_Nation_Charismatic_pct2010' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Num_UNStatDiv) AS DistinctRows, Field = 'Pew_Nation_Num_UNStatDiv' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT SubRegion6) AS DistinctRows, Field = 'Pew_Nation_SubRegion6' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Internet_user_pct) AS DistinctRows, Field = 'Pew_Nation_Internet_user_pct' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Source_GDP_per_capita) AS DistinctRows, Field = 'Pew_Nation_Source_GDP_per_capita' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT Source_Adult_Literacy_Pct) AS DistinctRows, Field = 'Pew_Nation_Source_Adult_Literacy_Pct' FROM forum.dbo.Pew_Nation UNION SELECT COUNT (DISTINCT MainSources) AS DistinctRows, Field = 'Pew_Nation_MainSources' FROM forum.dbo.Pew_Nation 
 ...
 UNION SELECT COUNT (DISTINCT pew_migration_pk) AS DistinctRows, Field = 'Pew_Migration_pew_migration_pk' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT pew_religion_group_fk) AS DistinctRows, Field = 'Pew_Migration_pew_religion_group_fk' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT destination_nation_fk) AS DistinctRows, Field = 'Pew_Migration_destination_nation_fk' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT migrant_count) AS DistinctRows, Field = 'Pew_Migration_migrant_count' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT origin_nation_fk) AS DistinctRows, Field = 'Pew_Migration_origin_nation_fk' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT field_fk) AS DistinctRows, Field = 'Pew_Migration_field_fk' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT Display_by_Religion) AS DistinctRows, Field = 'Pew_Migration_Display_by_Religion' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT Display_as_Destination_Ctry) AS DistinctRows, Field = 'Pew_Migration_Display_as_Destination_Ctry' FROM forum.dbo.Pew_Migration UNION SELECT COUNT (DISTINCT Display_as_Origin_Ctry) AS DistinctRows, Field = 'Pew_Migration_Display_as_Origin_Ctry' FROM forum.dbo.Pew_Migration 
 ...
 UNION SELECT COUNT (DISTINCT Preferred_scenario_pk) AS DistinctRows, Field = 'Pew_Preferred_Scenario_Preferred_scenario_pk' FROM forum.dbo.Pew_Preferred_Scenario UNION SELECT COUNT (DISTINCT Nation_fk) AS DistinctRows, Field = 'Pew_Preferred_Scenario_Nation_fk' FROM forum.dbo.Pew_Preferred_Scenario UNION SELECT COUNT (DISTINCT Field_fk) AS DistinctRows, Field = 'Pew_Preferred_Scenario_Field_fk' FROM forum.dbo.Pew_Preferred_Scenario UNION SELECT COUNT (DISTINCT Preferred_scenario_id) AS DistinctRows, Field = 'Pew_Preferred_Scenario_Preferred_scenario_id' FROM forum.dbo.Pew_Preferred_Scenario 
 ...
 UNION SELECT COUNT (DISTINCT Question_Std_pk) AS DistinctRows, Field = 'Pew_Question_Std_Question_Std_pk' FROM forum.dbo.Pew_Question_Std UNION SELECT COUNT (DISTINCT Question_abbreviation_std) AS DistinctRows, Field = 'Pew_Question_Std_Question_abbreviation_std' FROM forum.dbo.Pew_Question_Std UNION SELECT COUNT (DISTINCT Question_wording_std) AS DistinctRows, Field = 'Pew_Question_Std_Question_wording_std' FROM forum.dbo.Pew_Question_Std UNION SELECT COUNT (DISTINCT Question_short_wording_std) AS DistinctRows, Field = 'Pew_Question_Std_Question_short_wording_std' FROM forum.dbo.Pew_Question_Std 
 UNION SELECT COUNT (DISTINCT Question_topic_pk) AS DistinctRows, Field = 'Pew_Question_Topic_Question_topic_pk' FROM forum.dbo.Pew_Question_Topic UNION SELECT COUNT (DISTINCT Question_Std_fk) AS DistinctRows, Field = 'Pew_Question_Topic_Question_Std_fk' FROM forum.dbo.Pew_Question_Topic UNION SELECT COUNT (DISTINCT Topic_fk) AS DistinctRows, Field = 'Pew_Question_Topic_Topic_fk' FROM forum.dbo.Pew_Question_Topic UNION SELECT COUNT (DISTINCT Priority_order) AS DistinctRows, Field = 'Pew_Question_Topic_Priority_order' FROM forum.dbo.Pew_Question_Topic 
 UNION SELECT COUNT (DISTINCT Religion_group_pk) AS DistinctRows, Field = 'Pew_Religion_Group_Religion_group_pk' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Wrd_religion_code) AS DistinctRows, Field = 'Pew_Religion_Group_Wrd_religion_code' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev04) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev04' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev03) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev03' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev02) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev02' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev01) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev01' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev00) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev00' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT wrd_religion_1) AS DistinctRows, Field = 'Pew_Religion_Group_wrd_religion_1' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT wrd_religion_2) AS DistinctRows, Field = 'Pew_Religion_Group_wrd_religion_2' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT wrd_religion_3) AS DistinctRows, Field = 'Pew_Religion_Group_wrd_religion_3' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev01_5) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev01_5' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev02_5) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev02_5' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_religion_lev05) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_religion_lev05' FROM forum.dbo.Pew_Religion_Group UNION SELECT COUNT (DISTINCT Pew_RelL02_Display) AS DistinctRows, Field = 'Pew_Religion_Group_Pew_RelL02_Display' FROM forum.dbo.Pew_Religion_Group 
...
/*** >> TLK: Table of Links for fk-pk ****************************************************************************************/
 SELECT 
        ...
        , Field_Name_x  = CASE
                               ...
                               WHEN COLUMN_NAME LIKE 'WRD_religion_code_fk'
                               THEN                  'Code_value'
